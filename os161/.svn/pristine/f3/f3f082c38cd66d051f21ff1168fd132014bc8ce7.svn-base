...
#define P_TABLE_SIZE 100
#define MAX_NUM_CHILD 10

extern struct process_info *process_table;

struct process_info{
	int pid;//OS is 0, and process starts from 1
	int status;//0-unused 1-active 2-used
	int exitCode;//-1-unreturned/error 0-returned success
	int numOfChild;
	int* childIDs;//array of all children IDs
	int has_been_waited;
};
...
/*
 * Wake up only one thread who are sleeping on "sleep address"
 * ADDR.
 */
